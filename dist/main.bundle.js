...
exports.easeInOut = animations_1.trigger('easeInOut', [
    animations_1.transition(':enter', [
        ...
        animations_1.animate('0.5s ease-in-out', animations_1.style({
            opacity: 1,
            right: '0rem',
            transform: 'skewX(0)'
        }))
...
exports.expandCard = animations_1.trigger('expandCard', [
    animations_1.transition(':enter', [
        animations_1.style({
            opacity: 0,
            right: '-15rem',
    ...
    animations_1.transition(':leave', [
        ...
        animations_1.animate('.1s ease-in-out', animations_1.style({
            opacity: 0,
            display: 'none'
        }))
    ])
]);
exports.itemAnimTrigger = animations_1.trigger('itemAnim', [
    animations_1.state('default', animations_1.style({
        background: 'yellow',
        height: '10rem'
    })),
    animations_1.state('clicked', animations_1.style({
        background: 'pink',
        height: '15rem'
    })),
    animations_1.transition('void <=> *', animations_1.animate('400ms 1000ms ease-in'))
]);
exports.btnAnimConfirmTrigger = animations_1.trigger('btnAnimConfirm', [
    animations_1.state('default', animations_1.style({
    ...
    animations_1.transition('default <=> clicked', animations_1.animate('0.8s 0.2s ease-in', animations_1.keyframes([
        animations_1.style({ background: 'red' }),
        animations_1.style({ background: 'black' }),
    ])))
]);
exports.ngIfShowCard = animations_1.trigger('ngIfShowCard', [
    animations_1.transition('void => *', [
        animations_1.query('*', animations_1.style({ opacity: 0, transform: 'scaleY(0.9)' }), { optional: true }),
        animations_1.query('*', animations_1.animate('0.3s ease-in', animations_1.style({ opacity: 1, transform: 'scaleY(1.0)' })), { optional: true }),
    ]),
    animations_1.transition('* => void', [
        animations_1.query('*', animations_1.style({ opacity: 1, transform: 'scaleY(1.0)' }), { optional: true }),
        animations_1.query('*', animations_1.animate('0.2s ease-in', animations_1.keyframes([
            animations_1.style({ opacity: 1, transform: 'scaleY(1.01)' }),
            animations_1.style({ opacity: 0, transform: 'scaleY(0.9)' }),
        ])), { optional: true }),
    ]),
]);
...
var logs_service_1 = __webpack_require__("./src/app/services/logs.service.ts");
var forms_2 = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
var week_pipe_1 = __webpack_require__("./src/app/pipes/week.pipe.ts");
var search_pipe_1 = __webpack_require__("./src/app/pipes/search.pipe.ts");
var navbar_component_1 = __webpack_require__("./src/app/components/navbar/navbar.component.ts");
var service_worker_1 = __webpack_require__("./node_modules/@angular/service-worker/esm5/service-worker.js");
var environment_1 = __webpack_require__("./src/environments/environment.ts");
var add_log_component_1 = __webpack_require__("./src/app/components/dashboard/add-log/add-log.component.ts");
var notification_service_1 = __webpack_require__("./src/app/services/notification.service.ts");
var notifications_component_1 = __webpack_require__("./src/app/components/notifications/notifications.component.ts");
var logs_container_component_1 = __webpack_require__("./src/app/components/dashboard/logs-container/logs-container.component.ts");
var search_component_1 = __webpack_require__("./src/app/components/dashboard/logs-container/search/search.component.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                week_pipe_1.WeekPipe,
                navbar_component_1.NavbarComponent,
                add_log_component_1.AddLogComponent,
                notifications_component_1.NotificationsComponent,
                logs_container_component_1.LogsContainerComponent,
                search_component_1.SearchComponent,
                search_pipe_1.FilterPipe
            ],
            imports: [
            ...
            providers: [logs_service_1.LogsService, notification_service_1.NotificationService],
...
var AddLogComponent = /** @class */ (function () {
    function AddLogComponent(_logsService, _notificationService, fb, weekPipe) {
        ...
        this.alert = '';
        this.selectStory = new core_1.EventEmitter();
        this.callFakeLogs = new core_1.EventEmitter();
        this.getAllLogs();
    }
    AddLogComponent.prototype.onSelectStory = function () {
        this.selectStory.emit(true);
    };
    AddLogComponent.prototype.getAllLogs = function () {
        var _this = this;
    ...
    AddLogComponent.prototype.ngOnInit = function () {
        this.myForm = this.fb.group({
            type: '',
            week: ['', forms_1.Validators.max(52)],
            day: '',
    ...
    AddLogComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/components/dashboard/add-log/add-log.component.html"),
            styles: [__webpack_require__("./src/app/components/dashboard/add-log/add-log.component.sass")],
            providers: [week_pipe_1.WeekPipe]
        }),
        __metadata("design:paramtypes", [logs_service_1.LogsService, notification_service_1.NotificationService, forms_1.FormBuilder, week_pipe_1.WeekPipe])
    ], AddLogComponent);
    return AddLogComponent;
}());
exports.AddLogComponent = AddLogComponent;
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(_logsService, weekPipe) {
        ...
        this.weekPipe = weekPipe;
        this.today = Date.now();
        this.userIdofCurrent = { 'userId': '72315f' };
        this.formSuccesfullySubmited = false;
    ...
    DashboardComponent = __decorate([
        core_1.Component({
            ...
            animations: [
                animations_1.easeInOut,
                animations_1.expandCard
            ],
            providers: [week_pipe_1.WeekPipe]
        }),
        __metadata("design:paramtypes", [logs_service_1.LogsService, week_pipe_1.WeekPipe])
    ], DashboardComponent);
...
var LogsContainerComponent = /** @class */ (function () {
    ...
    LogsContainerComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/components/dashboard/logs-container/logs-container.component.html"),
            styles: [__webpack_require__("./src/app/components/dashboard/logs-container/logs-container.component.sass")],
            animations: [
                animations_1.easeInOut,
                animations_1.expandCard
            ],
        }),
        __metadata("design:paramtypes", [logs_service_1.LogsService, notification_service_1.NotificationService])
    ], LogsContainerComponent);
    return LogsContainerComponent;
}());
exports.LogsContainerComponent = LogsContainerComponent;
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent = __decorate([
        core_1.Component({
            selector: 'app-search',
            template: __webpack_require__("./src/app/components/dashboard/logs-container/search/search.component.html"),
            styles: [__webpack_require__("./src/app/components/dashboard/logs-container/search/search.component.sass")],
        }),
...
module.exports = "<nav>\r\n  <a href=\"#\"><div id=\"icon\"></div>Log Yourself</a>\r\n  <div>{{today | date:'dd.MM.yyyy' }}, {{today | date:'EEEE' }} - Week {{today | week }}</div>\r\n</nav>"
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__("./src/app/components/navbar/navbar.component.sass")]
        }),
...
var NotificationsComponent = /** @class */ (function () {
    ...
    NotificationsComponent = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__("./src/app/components/notifications/notifications.component.sass")],
            animations: [animations_1.easeInOut]
        }),
...
var WeekPipe = /** @class */ (function () {
    ...
    WeekPipe = __decorate([
        core_1.Pipe({ name: 'week' })
    ], WeekPipe);
    return WeekPipe;
}());
exports.WeekPipe = WeekPipe;
...
var LogsService = /** @class */ (function () {
    function LogsService(_http) {
        this._http = _http;
        this.logs = new BehaviorSubject_1.BehaviorSubject([]);
    }
...
var NotificationService = /** @class */ (function () {
    ...
    NotificationService.prototype.getNotification = function () {
        var alert = Observable_1.Observable.of(this.notification);
        return alert;
    };
